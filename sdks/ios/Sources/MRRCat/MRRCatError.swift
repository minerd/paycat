...
/// MRRCat SDK Errors
public enum MRRCatError: LocalizedError {
    case notConfigured
    case invalidURL
    case networkError
    case httpError(Int)
    ...
    public var errorDescription: String? {
        switch self {
        case .notConfigured:
            return "MRRCat is not configured. Call MRRCat.shared.configure() first."
        case .invalidURL:
    ...
    public var recoverySuggestion: String? {
        switch self {
        case .notConfigured:
            return "Configure MRRCat in your app delegate with your API key."
        case .networkError:
