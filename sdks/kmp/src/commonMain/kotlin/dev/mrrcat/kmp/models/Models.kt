package dev.mrrcat.kmp.models

import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

/**
 * Configuration options for MRRCat SDK
 */
data class MRRCatConfiguration(
    val apiKey: String,
 ...
 * MRRCat error
 */
sealed class MRRCatError : Exception() {
    data class NotConfigured(override val message: String = "MRRCat not configured") : MRRCatError()
    data class NotLoggedIn(override val message: String = "No user logged in") : MRRCatError()
    data class NetworkError(override val message: String, val cause: Throwable? = null) : MRRCatError()
    data class PurchaseError(override val message: String, val code: String? = null) : MRRCatError()
    data class ServerError(override val message: String, val statusCode: Int) : MRRCatError()
    data class Unknown(override val message: String) : MRRCatError()
}
